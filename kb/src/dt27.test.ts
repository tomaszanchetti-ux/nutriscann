...
test("el lote es ADITIVO: nada se retira y la versión es 3.6.0", () => {
  ...
  // lo movió a 3.6.0 con una: `manual-torrezno-de-soria`. Las 14 de
  ...
  assert.match(catalog.kb_version, /^3\.6\.0\+[0-9a-f]{8}$/);
