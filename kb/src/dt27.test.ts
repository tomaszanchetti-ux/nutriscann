...
test("el lote es ADITIVO: nada se retira y la versión es 3.5.0", () => {
  ...
  // 3.5.0 con dos más: `receta-calcots` y `manual-salsa-de-calcots`. Las 14 de
  ...
  assert.match(catalog.kb_version, /^3\.5\.0\+[0-9a-f]{8}$/);
