/* =============================================================================
 * GENERADO desde kb/src/types.ts — NO EDITAR.
 *
 * Esto es una COPIA. La fuente de verdad es `kb/src/types.ts` y se edita allá.
 *
 ...
 *
 * Para regenerarla: copiar `kb/src/types.ts` debajo del centinela, tal cual.
 * =============================================================================
 */
